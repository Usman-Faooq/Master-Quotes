    ...
    public void onBindViewHolder(@NonNull MyHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (getBG.equals("Color")){
            ...
            if (bgnumber == 0){
                ...
                Blurry.with(context).radius(25).sampling(2).onto(holder.layout);
            }else if (bgnumber == 1){
                bgnumber = 2;
        ...
        holder.quoteContent.setText(list.get(position).getQuote_content());
        holder.quoteAuthor.setText("-" + list.get(position).getQuote_auther());
        ...
        holder.copyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData clipData = ClipData.newPlainText("Quote: " , list.get(position).getQuote_content());
        ...
        //Bookmark Button
        String quote = list.get(position).getQuote_content();
        String author = list.get(position).getQuote_auther();
